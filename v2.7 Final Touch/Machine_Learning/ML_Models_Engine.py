...
def targeted_column(user_input, processed_file, report):
    ...
    if os.path.exists("processed_data.csv") and os.path.exists("processed_data_metadata.json"):
        print("Processed files already exist. Skipping preprocessing...")
        processed_file = "processed_data.csv"
        with open("processed_data_metadata.json", 'r') as f:
            report = json.load(f)
    else:
        print("Processing dataset...")
        preprocessor = DatasetPreprocessor(verbose=False)
        processed_file, report_path = preprocessor.process_dataset()
