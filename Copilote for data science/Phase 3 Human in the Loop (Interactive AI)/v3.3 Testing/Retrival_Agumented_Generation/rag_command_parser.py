...
CSV_FILE = r"E:\Projects\Copilot-For-Data-Science\Copilote for data science\Phase 3 Human in the Loop (Interactive AI)\v3.3 Testing\Retrival_Agumented_Generation\commands_database.csv"
